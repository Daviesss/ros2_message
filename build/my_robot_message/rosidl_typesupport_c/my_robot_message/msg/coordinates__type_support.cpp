...
#include "my_robot_message/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Coordinates_type_support_symbol_names_t _Coordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_message, msg, Coordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_message, msg, Coordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_my_robot_message
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_robot_message, msg, Coordinates)() {
  return &::my_robot_message::msg::rosidl_typesupport_c::Coordinates_message_type_support_handle;
}
