...
#include <stddef.h>
#include "my_robot_message/msg/detail/coordinates__rosidl_typesupport_introspection_c.h"
#include "my_robot_message/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  my_robot_message__msg__Coordinates__init(message_memory);
}

void Coordinates__rosidl_typesupport_introspection_c__Coordinates_fini_function(void * message_memory)
{
  my_robot_message__msg__Coordinates__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Coordinates__rosidl_typesupport_introspection_c__Coordinates_message_member_array[2] = {
  {
    ...
    offsetof(my_robot_message__msg__Coordinates, name),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_message__msg__Coordinates, coordinates),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Coordinates__rosidl_typesupport_introspection_c__Coordinates_message_members = {
  "my_robot_message__msg",  // message namespace
  "Coordinates",  // message name
  2,  // number of fields
  sizeof(my_robot_message__msg__Coordinates),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_my_robot_message
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_robot_message, msg, Coordinates)() {
  Coordinates__rosidl_typesupport_introspection_c__Coordinates_message_member_array[1].members_ =
