...
#include "my_robot_message/msg/detail/coordinates__rosidl_typesupport_fastrtps_c.h"
...
#include "my_robot_message/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_my_robot_message
...
using _Coordinates__ros_msg_type = my_robot_message__msg__Coordinates;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_message
size_t get_serialized_size_my_robot_message__msg__Coordinates(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Coordinates__ros_msg_type * ros_message = static_cast<const _Coordinates__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Coordinates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_message__msg__Coordinates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_message
size_t max_serialized_size_my_robot_message__msg__Coordinates(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_my_robot_message__msg__Coordinates(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_message, msg, Coordinates)() {
