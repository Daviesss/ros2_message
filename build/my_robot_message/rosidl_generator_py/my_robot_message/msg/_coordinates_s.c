...
bool my_robot_message__msg__coordinates__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_message.msg._coordinates.Coordinates", full_classname_dest, 45) == 0);
  }
  my_robot_message__msg__Coordinates * ros_message = _ros_message;
  {  // name
...
PyObject * my_robot_message__msg__coordinates__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_message.msg._coordinates");
