...
#include "message_creation/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Creation_type_support_symbol_names_t _Creation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, message_creation, msg, Creation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, message_creation, msg, Creation)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_message_creation
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, message_creation, msg, Creation)() {
  return &::message_creation::msg::rosidl_typesupport_c::Creation_message_type_support_handle;
}
