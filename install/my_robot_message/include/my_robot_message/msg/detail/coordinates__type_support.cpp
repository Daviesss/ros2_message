...
{
  new (message_memory) my_robot_message::msg::Coordinates(_init);
}

void Coordinates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_message::msg::Coordinates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Coordinates_message_member_array[2] = {
  {
    ...
    offsetof(my_robot_message::msg::Coordinates, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_message::msg::Coordinates, coordinates),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Coordinates_message_members = {
  "my_robot_message::msg",  // message namespace
  "Coordinates",  // message name
  2,  // number of fields
  sizeof(my_robot_message::msg::Coordinates),
...
{
  return &::my_robot_message::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_message, msg, Coordinates)() {
  return &::my_robot_message::msg::rosidl_typesupport_introspection_cpp::Coordinates_message_type_support_handle;
}
