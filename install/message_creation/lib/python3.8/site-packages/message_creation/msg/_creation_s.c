...
bool message_creation__msg__creation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("message_creation.msg._creation.Creation", full_classname_dest, 39) == 0);
  }
  message_creation__msg__Creation * ros_message = _ros_message;
  {  // day
...
{
  /* NOTE(esteve): Call constructor of Creation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("message_creation.msg._creation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Creation");
